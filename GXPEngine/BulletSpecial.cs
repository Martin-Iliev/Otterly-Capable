...
class BulletSpecial : Sprite
{
    ...
    public BulletSpecial(Vec2 pPosition, Vec2 pVelocity) : base("assets/bulletSpecial.png")
    {
    ...
    void ResolveCollision(CollisionInfo col)
    {
        ...
        {
            (col.other.owner as SquareBrick).GetsHitValue(10);
            velocity.y = savedY;
            //bounce square
        ...
        {
            (col.other.owner as SquareBrickBouncy).GetsHitValue(10);
            velocity.y = savedY;
            //bounce square
        ...
        {
            (col.other.owner as TriangleBrick).GetsHitValue(10);
            velocity.y = savedY;
        ...
        if (col.other.owner is BulletSpecial)
        {
            velocity.Reflect(col.normal, 0.45f);
        }
        if (col == null) return;
